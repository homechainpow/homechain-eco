...
startBtn.onclick = async () => {
    if (isRunning) {
        ...
        try {
            ...
            // Pass an empty string for the ignored wallet address and set auto_rotate=true
            await invoke('start_mining', { walletAddress: "", threads: threads, rpcUrl: rpc, autoRotate: true });
            isRunning = true;
            updateUI();
        } catch (error) {
